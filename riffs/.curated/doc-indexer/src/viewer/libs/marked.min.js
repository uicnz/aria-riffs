...
!((e, t) => {
    ...
    class w {
        ...
        table(e) {
            ...
            if (n.length === s.length) {
                ...
                for (const e of r)
                    i.rows.push(d(e, i.header.length).map(e => ({ text: e, tokens: this.lexer.inline(e) })));
                return i;
            }
        }
        lheading(e) {
    ...
    const m = /^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,
        ...
        v = /^( {2,}|\\)\n(?!\s*$)/,
        B = '\\p{P}$+<=>`^|~',
        M = k(/^((?![*_])[\spunctuation])/, 'u')
            .replace(/punctuation/g, B)
            .getRegex(),
        O = k(/^(?:\*+(?:((?!\*)[punct])|[^\s*]))|^_+(?:((?!_)[punct])|([^\s_]))/, 'u')
            .replace(/punct/g, B)
            .getRegex(),
        C = k(
    ...
    class ne {
        ...
        constructor(t) {
            ...
            this.options.pedantic
                ...
                : this.options.gfm &&
                  ((n.block = ee.gfm), this.options.breaks ? (n.inline = te.breaks) : (n.inline = te.gfm)),
        ...
        blockTokens(e, t = []) {
            ...
            for (
                e = this.options.pedantic
                    ...
                    : e.replace(/^( *)(\t+)/gm, (_e, t, n) => t + '    '.repeat(n.length));
                e;
            )
                if (
                    ...
                    if ((n = this.tokenizer.space(e)))
                        ...
                        if (((r = e), this.options.extensions?.startBlock)) {
                            let t = 1 / 0;
                            const n = e.slice(1);
                            let s;
            ...
            for (; e; )
                if (
                    ...
                    if ((n = this.tokenizer.escape(e))) (e = e.substring(n.raw.length)), t.push(n);
                        ...
                        if (((r = e), this.options.extensions?.startInline)) {
                            let t = 1 / 0;
                            const n = e.slice(1);
                            let s;
    ...
    (ce.options = ce.setOptions = e => (ae.setOptions(e), (ce.defaults = ae.defaults), n(ce.defaults), ce)),
        (ce.getDefaults = t),
        (ce.defaults = e.defaults),
        (ce.use = (...e) => (ae.use(...e), (ce.defaults = ae.defaults), n(ce.defaults), ce)),
        (ce.walkTokens = (e, t) => ae.walkTokens(e, t)),
