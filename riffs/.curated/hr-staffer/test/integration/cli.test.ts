...
describe('generateOrgChart integration', () => {
	...
	let logger: Logger;
	const fixturePath = path.resolve('riffs/.curated/hr-staffer/test/fixtures');
	const testConfigPath = path.resolve('riffs/.curated/hr-staffer/test/fixtures/config.yaml');
