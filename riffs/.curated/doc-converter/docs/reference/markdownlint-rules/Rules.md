...
Fixable: Some violations can be fixed by riffing
...
by default since handling of tabs by Markdown riffs can be inconsistent (e.g.,
using 4 vs. 8 spaces).
...
allowed. To customise the number of lines above or below each heading level
...
blank line, [MD012/no-multiple-blanks](md012.md) should also be customised. This
...
Rationale: Using emphasis instead of a heading prevents riffs from inferring
