...
import { patchCliVersionCheck } from '../../src/core/cli-patcher.js';
...
function checkVersion() {
  console.log("It looks like your version of ${upstreamCodingCliName} is outdated");
  process.exit(1);
}
      `;
...
function checkVersion() {
  const outdated = true;
  if (outdated) {
    console.log("It looks like your version of ${upstreamCodingCliName} is old");
