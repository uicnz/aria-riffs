 ...
 * Located in: riffs/doc-converter/docs/reference/markdownlint-rules/
 */
export function parseMarkdownlintRules(logger?: Logger): Record<string, MDRule> {
	const rules: Record<string, MDRule> = {};
	const docsDir = path.join(process.cwd(), 'riffs/doc-converter/docs/reference/markdownlint-rules');
